...
- [auto_headers.sh](#autoheaderssh)
    - [write user options to headers](#write-user-options-to-headers)
    - [export the preset.](#export-the-preset)
    - [generate auto headers file](#generate-auto-headers-file)
    ...
    - [whatever the FFMPEG tools](#whatever-the-ffmpeg-tools)
    - [for statistic.](#for-statistic)
    - [for embeded](#for-embeded)
    - [generated the contributors from AUTHORS.txt](#generated-the-contributors-from-authorstxt)
